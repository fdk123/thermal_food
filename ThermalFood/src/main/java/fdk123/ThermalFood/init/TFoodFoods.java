...
public class TFoodFoods {
    ...
    public static final Food MAYONNAISE = new Food.Builder().hunger(2).saturation(0.1F).build();

    //PIE
    public static final Food KHACHAPURI = new Food.Builder().hunger(8).saturation(0.8F).setAlwaysEdible().build();
    public static final Food KULEBYAKA_WITH_MEAT = new Food.Builder().hunger(10).saturation(0.8F).setAlwaysEdible().build();
    public static final Food KULEBYAKA_WITH_COD = new Food.Builder().hunger(8).saturation(0.8F).setAlwaysEdible().build();
    public static final Food KULEBYAKA_WITH_SALMON = new Food.Builder().hunger(8).saturation(0.8F).setAlwaysEdible().build();
    ...
    //french
    public static final Food JULIENNE = new Food.Builder().hunger(3).saturation(0.6F).setAlwaysEdible().build();
    ...
    //italian
    public static final Food PIZZA = new Food.Builder().hunger(8).saturation(0.6F).setAlwaysEdible().build();
    ...
    public static final Food SHAVERMA = new Food.Builder().hunger(14).saturation(0.8F).setAlwaysEdible().build();
    public static final Food PILAF = new Food.Builder().hunger(20).saturation(1F).setAlwaysEdible().build();
    public static final Food SUSHI_ROLL = new Food.Builder().hunger(1).saturation(0.5F).setAlwaysEdible().build();
    ...
    public static final Food COFFEE_CUP = new Food.Builder().hunger(1).saturation(0.1F)
            .effect(() -> new EffectInstance(SPEED, 7000, 1), 1.0F)
            .effect(() -> new EffectInstance(HASTE, 7000, 1), 1.0F)
            .setAlwaysEdible().build();
    ...
    public static final Food CAPPUCCINO = new Food.Builder().hunger(1).saturation(0.1F)
            .effect(() -> new EffectInstance(SPEED, 5000, 1), 1.0F)
            .effect(() -> new EffectInstance(HASTE, 5000, 1), 1.0F)
            .setAlwaysEdible().build();
